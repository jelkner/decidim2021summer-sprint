...
**July 15:** Today we tried to set up the Linux computers for the meeting that is occurring on Monday. BigBlueButton was used to set them up. They were connected to the television in the freezer room and both worked with sharing the screen. What didn't seem to work was the microphone in the second computer while in the meeting, and the first computer crashed. I am getting used to the Decidim website to be able to work with it well when I use it later in the internship.
